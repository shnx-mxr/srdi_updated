          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="service-box">
              ...
              <div class="services-list">
                <a href="./mrd.php" ><i class="bi bi-arrow-right-circle"></i><span>MRD</span></a>
                <a href="./srd.php" class="active"><i class="bi bi-arrow-right-circle"></i><span>SRD</span></a>
                <a href="./prd.php"><i class="bi bi-arrow-right-circle"></i><span>PRD</span></a>
                <a href="./serd.php"><i class="bi bi-arrow-right-circle"></i><span>S-eRD</span></a>
...
srdi@dmmmsu.edu.ph</a></p>
          ...
          <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
            <img src="./landing_assets/img/srd.png" alt="" class="img-fluid services-img">
            <h3>Silkworm Research and Development </h3>
            <p>
          The Silkworm R&D Program develops improved silkworm breeds and technologies to support efficient and sustainable sericulture. 
             </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Develop pure lines and hybrids with disease- and temperature-resistant traits</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Maintain and breed bivoltine and multivoltine races, including sex-linked breeds</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Develop rearing technologies, pest management strategies, and egg production techniques</span></li>
                            <li><i class="bi bi-check-circle"></i> <span>Verify production technologies at farmers’ fields</span></li>
            </ul>
          
            <p>
            The program focuses on breeding silkworms through various techniques to produce pure lines and hybrids, including disease- and temperature-resistant varieties. The Breeding unit maintains germplasm and continuously produces bivoltine and multivoltine crosses, as well as sex-linked breeds to facilitate egg production. Additionally, the unit develops silkworm rearing technologies, pest management strategies, and egg production methods, while also testing and verifying production technologies directly in farmers’ fields
            </p>
          </div>
